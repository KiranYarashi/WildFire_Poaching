...
def main():
    ...
    <div style='text-align: center;'>
        ...
        <p></a> detection model trained on the <a href='https://github.com/KiranYarashi/Model_dataset/tree/main'>D-Fire: an image dataset for fire and smoke detection</a>.</p>
